...
NAvalue(elev) <- -9999
writeRaster(elev, 'elevation.asc',overwrite=TRUE)  


#climate vars to download
...
ClimateNA_cmdLine(
  ...
  wkDir = "/Users/katherine/Desktop/PhD/github/song-sparrow-WGS/ClimateNA_v741/",
  period = "Decade_2001_2010.dcd",
  MSY = "Y",
  "/Users/katherine/Desktop/PhD/github/song-sparrow-WGS/GF/elevation.asc",
  "/Users/katherine/Desktop/PhD/github/song-sparrow-WGS/GF/test"
)



#using raster (.ASC) input/output files
exe = "ClimateNA_v7.42.exe"
wkDir = "/Users/katherine/Desktop/PhD/github/song-sparrow-WGS/ClimateNA_V742/"
inputFile = '/Users/katherine/Desktop/PhD/github/song-sparrow-WGS/ClimateNA_v742/InputFiles/na4000.asc'
outputFile = '/Users/katherine/Desktop/PhD/github/song-sparrow-WGS/GF/Decade_2001_2010/'
period = 'Decade_2001_2010.dcd'
ClimateNA_cmdLine(exe,wkDir,period,MSY='Y',inputFile, outputFile)



setwd("/Users/katherine/Desktop/PhD/github/song-sparrow-WGS/ClimateNA_V742/")
#setwd("G:/ClimateNA70/"); # set the ClimateNA root directory as the working directory



exe <- "ClimateNA_v7.42.exe"
inputFile = '/Users/katherine/Desktop/PhD/github/song-sparrow-WGS/ClimateNA_v742/InputFiles/na4000.asc'
outputDir = '/Users/katherine/Desktop/PhD/github/song-sparrow-WGS/GF/Decade_2001_2010/' 
yearPeriod = '/Decade_2001_2010.dcd'
system2(exe,args= c('/Y', yearPeriod, inputFile, outputDir) ,wait=TRUE)
